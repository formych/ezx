...
var file_config_log_proto_goTypes = []interface{}{
...
func file_config_log_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_config_log_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Rotate); i {
			case 0:
				return &v.state
			case 1:
		...
		file_config_log_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
